...
![Latest Release](https://img.shields.io/github/v/release/Uplinkpro/CartLaunchCompanion?display_name=tag)
<br>
...
Run the included launcher script or executable.
...
Local video files
Steam adaptive video streams
Steam-hosted trailer files
YouTube links
Direct video URLs
...
Stop active trailer playback.
Hide the launcher.
Detect the configured game process.
Wait for the game to close.
Show the launcher again.
Restore fullscreen mode and request foreground focus.
...
Open a proposal describing the change.
