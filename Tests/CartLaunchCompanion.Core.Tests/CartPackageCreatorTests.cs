...
public sealed class CartPackageCreatorTests
{
    ...
    public async Task CreateAsync_BuildsCleanMediaLayoutAndExcludesDevelopmentFiles()
    {
        ...
        try
        {
            ...
            Directory.CreateDirectory(Path.Combine(source, "System", "Assets", "Collections", "Demo", "Concepts"));
            ...
            await File.WriteAllTextAsync(Path.Combine(source, "System", "Assets", "Collections", "Demo", "Concepts", "draft.png"), "draft");
            ...
            Assert.False(Directory.Exists(Path.Combine(result.CartRoot, "System", "Assets", "Collections", "Demo", "Concepts")));
